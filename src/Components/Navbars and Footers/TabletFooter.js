...
export default function Tabletfooter() {
  ...
  return (
    <div className="flex flex-col w-full h-[423px] bg-black items-center  mediumhide largehide relative">
      ...
      <div className="flex w-full justify-between px-16 mb-[10px]">
        <div className="w-[202px] lightlogo   h-[27px]  bg-cover"></div>

        <div className="flex  jost14  text-white font-light h-[27px] space-x-12 px-5 justify-center ">
      ...
      <div className="flex w-full justify-between px-16 mt-16 ">
        ...
        <div className="flex space-x-4 mb-10 pt-12">
