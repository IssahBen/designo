...
function TabletCategory() {
  return (
    <div className="flex flex-col w-[689px] h-[649px]  space-y-8 mt-20 mediumhide largehide bg-white rounded-xl">
      <div className="flex flex-col items-center relative space-y-4 bg-black  tabletweb  justify-center  w-[689px] h-[200px] rounded-2xl text-white">
