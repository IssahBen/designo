...
function MobileCategory() {
  return (
    <div className="flex flex-col w-[327px] h-[798px]  space-y-5 mt-20 smallhide largehide">
      <div className="flex flex-col items-center relative space-y-4 bg-black  mobileweb  justify-center  w-[327px] h-[250px] rounded-2xl text-white">
        ...
        <NavLink
          to="/web"
          className="flex tracking-widest space-x-5 absolute z-10 "
        >
